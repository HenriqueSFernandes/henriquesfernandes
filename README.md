...
| [PFL1](https://sigarra.up.pt/feup/en/UCURR_GERAL.FICHA_UC_VIEW?pv_ocorrencia_id=541889) | [Haskell Graphs Problems](https://github.com/HenriqueSFernandes/PFL-STAQS)                       | $18.4_{/20}$  | Haskell implementation of some Graphs problems, such as Shortest Path and Travelling Sales Person.                                                                                                                                                                                                                                                                                           | $3^{rd} year, 1^{st} semester$ |
