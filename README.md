...
| [CPD1](https://sigarra.up.pt/feup/en/UCURR_GERAL.FICHA_UC_VIEW?pv_ocorrencia_id=541893) | [Multi-thread implementation of matrix multiplication](https://github.com/Process-ing/feup-iart1)                               | $?_{/20}$  | Single-thread and multi-thread implementation of different matrix multiplication algorithms.                                                                                                                                                                                                                                                                                                      | $3^{rd} year, 2^{nd} semester$ |
| [IART1](https://sigarra.up.pt/feup/en/UCURR_GERAL.FICHA_UC_VIEW?pv_ocorrencia_id=541894) | [Router Placement Optimization](https://github.com/Process-ing/feup-iart1)                               | $?_{/20}$  | Artificial Intelligence problem to optimize router placement and internet coverage                                                                                                                                                                                                                                                                                                                                                        | $3^{rd} year, 2^{nd} semester$ |
